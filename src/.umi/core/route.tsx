...
export async function getRoutes() {
  const routes = {"1":{"path":"/","name":"主页","icon":"smile","parentId":"ant-design-pro-layout","id":"1"},"2":{"path":"/interface","name":"接口广场","icon":"smile","parentId":"ant-design-pro-layout","id":"2"},"3":{"path":"/interface_info/:id","name":"查看接口","icon":"smile","hideInMenu":true,"parentId":"ant-design-pro-layout","id":"3"},"4":{"path":"/user","layout":false,"id":"4"},"5":{"name":"登录","path":"/user/login","parentId":"4","id":"5"},"6":{"name":"注册","path":"/user/register","parentId":"4","id":"6"},"7":{"path":"/admin","name":"管理页","icon":"crown","access":"canAdmin","parentId":"ant-design-pro-layout","id":"7"},"8":{"name":"接口管理","icon":"table","path":"/admin/interface_info","layout":{"contentWidth":"Fixed"},"parentId":"7","id":"8"},"9":{"name":"接口分析","icon":"analysis","path":"/admin/interface_analysis","parentId":"7","id":"9"},"10":{"path":"*","layout":false,"id":"10"},"ant-design-pro-layout":{"id":"ant-design-pro-layout","path":"/","isLayout":true},"umi/plugin/openapi":{"path":"/umi/plugin/openapi","id":"umi/plugin/openapi"}} as const;
  return {
    routes,
    routeComponents: {
...
'8': React.lazy(() => import(/* webpackChunkName: "p__Admin__interfaceInfoPro__index" */'@/pages/Admin/interfaceInfoPro/index.tsx')),
