...
export async function getRoutes() {
  const routes = {"1":{"path":"/","name":"主页","icon":"smile","parentId":"ant-design-pro-layout","id":"1"},"2":{"path":"/interface","name":"接口广场","icon":"smile","parentId":"ant-design-pro-layout","id":"2"},"3":{"path":"/user/userInfo","name":"个人信息","hideInMenu":true,"icon":"smile","parentId":"ant-design-pro-layout","id":"3"},"4":{"path":"/interface_info/:id","name":"查看接口","icon":"smile","hideInMenu":true,"parentId":"ant-design-pro-layout","id":"4"},"5":{"path":"/user","layout":false,"id":"5"},"6":{"name":"登录","path":"/user/login","parentId":"5","id":"6"},"7":{"name":"注册","path":"/user/register","parentId":"5","id":"7"},"8":{"path":"/admin","name":"管理页","icon":"crown","access":"canAdmin","parentId":"ant-design-pro-layout","id":"8"},"9":{"name":"接口管理","icon":"table","path":"/admin/interface_info","layout":{"contentWidth":"Fixed"},"parentId":"8","id":"9"},"10":{"name":"接口分析","icon":"analysis","path":"/admin/interface_analysis","parentId":"8","id":"10"},"11":{"path":"*","layout":false,"id":"11"},"ant-design-pro-layout":{"id":"ant-design-pro-layout","path":"/","isLayout":true}} as const;
  return {
    routes,
    routeComponents: {
...
'3': React.lazy(() => import(/* webpackChunkName: "p__User__UserInfo__index" */'@/pages/User/UserInfo/index.tsx')),
'4': React.lazy(() => import(/* webpackChunkName: "p__InterfaceInfo__index" */'@/pages/InterfaceInfo/index.tsx')),
'5': React.lazy(() => import('./EmptyRoute')),
'6': React.lazy(() => import(/* webpackChunkName: "p__User__Login__index" */'@/pages/User/Login/index.tsx')),
'7': React.lazy(() => import(/* webpackChunkName: "p__User__Register__index" */'@/pages/User/Register/index.tsx')),
